          ...
          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div className="modal-content">
              <div className="modal-header">
                <h1 className="modal-title-contact fs-1" id="exampleModalLabel">
                  Contact Me
                </h1>
                <button
                  type="button"
              ...
              <div className="modal-body fs-4 m-2">
                <form>
                  <label className="form-label-contact text-primary mb-5 fs-4">
                    Message
                  </label>
                  <textarea
                  ...
                  <div className="row m-2 mt-5">
                    <button
                      className="col-6 btn btn-primary bg-transparent text-primary fs-4"
                      type="button"
                      data-bs-dismiss="modal"
                    >
                      Close
                    ...
                    <button
                      className="col-6 btn btn-primary fs-4"
                      type="button"
