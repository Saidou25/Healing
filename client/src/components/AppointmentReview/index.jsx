        ...
        <div className='container mt-5'>
            <div className="card">
                <div className='card-header app-review-header'>
                    <h4 className='header-text mt-3 mb-3'>Please review your appointment information</h4>
                </div>
                <div className='card-body mt-4'>
                    <p className='app-review-p'>Appointment for: {profile.patientfirstname} {profile.patientlastname}</p>
                    <p className='app-review-p'>On: {addBookingdate.digitalAppointment} at: {addBookingdate.appTime}</p>
                    <p className='app-review-p'>Reason: {addBookingdate.reason}</p><br />
